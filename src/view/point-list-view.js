...
import { formatStringToDateTime, formatStringToShortDate, formatDuration } from '../utils/formate.js';
...
function createTripListTemplate ({ point, pointDestination, pointOffers }) {
  ...
  return (
    ...
    <div class="event">
      <time class="event__date" datetime="${formatStringToDateTime(dateFrom)}">${formatStringToDateTime(dateFrom)}</time>
